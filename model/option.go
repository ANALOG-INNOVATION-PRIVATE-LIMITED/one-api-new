...
func InitOptionMap() {
	...
	config.OptionMap["DiscordOAuthEnabled"] = strconv.FormatBool(config.DiscordOAuthEnabled)
	...
	config.OptionMap["DiscordClientId"] = ""
	config.OptionMap["DiscordClientSecret"] = ""
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") {
		...
		case "DiscordOAuthEnabled":
			config.DiscordOAuthEnabled = boolValue
		case "DiscordGuildCheckEnabled":
			config.DiscordGuildCheckEnabled = boolValue
		case "DiscordMemberRoleCheckEnabled":
			config.DiscordMemberRoleCheckEnabled = boolValue
	...
	case "DiscordClientId":
		config.DiscordClientId = value
	case "DiscordClientSecret":
		config.DiscordClientSecret = value
	case "DiscordGuildId":
		config.DiscordGuildId = value
	case "DiscordMemberRoleId":
		config.DiscordMemberRoleId = value
	case "Footer":
		config.Footer = value
	case "SystemName":
